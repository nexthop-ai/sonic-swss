...
=======
    ...
    def test_AclRuleInvalidPriorityHandling(self, dvs, dvs_acl, l3_acl_table):
        ...
        exitcode, log_output = dvs.runcmd(
            'sh -c "grep -E \'(Invalid ACL rule priority|Exception parsing ACL rule)\' /var/log/syslog | tail -30"')
...
>>>>>>> 0985c35a (NOS-4156: Handle acl operation with invalid priority (#448))
